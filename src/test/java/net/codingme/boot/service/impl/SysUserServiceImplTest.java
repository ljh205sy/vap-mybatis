...
//        SysUserVO source = new SysUserVO(3, "username", "password", "name");
...
//        SysUserVO source = new SysUserVO(3, "update-username", "update-password", "update-name");
//        SysUser target = new SysUser();
//        BeanUtils.copyProperties(source, target);
//    }
//
...
//        sysUser.setId(2);
//        SysUser queryUser = sysUserService.selectOne(sysUser);
//    }
//
//
//}